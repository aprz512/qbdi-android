...
void stopped_terminal_has_exact_v12_golden_bytes() {
    ...
    metrics.cache_hits = 0x0102030405060708ULL;
    metrics.cache_misses = 0x1112131415161718ULL;
    metrics.cache_collisions = 0x2122232425262728ULL;
    metrics.buffer_swaps = 0x3132333435363738ULL;
    metrics.producer_waits = 0x4142434445464748ULL;
    metrics.producer_wait_ns = 0x5152535455565758ULL;
    metrics.effective_buffer_bytes = 0x6162636465666768ULL;
